...
import (
	...
	http "github.com/jadczakd/summer-camp/summer_app/pkg/http"
...
var fs = flag.NewFlagSet("summer_app", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "summer_app")
